...
_FALLBACK_TEMPLATES: dict[str, str] = {
    "email_generation": (
        ...
        "- ONLY reference facts explicitly present in the CRM Context and Activity History above.\n"
        "- Do NOT invent meeting dates, deal amounts, product features, or any detail absent from the provided context.\n"
        "- If the context is insufficient to mention a specific fact, acknowledge the gap rather than speculating.\n\n"
    ...
    "sms_generation": (
        ...
        "- ONLY reference facts explicitly present in the CRM Context and Activity History above.\n"
        "- Do NOT invent meeting dates, deal amounts, product features, or any detail absent from the provided context.\n"
        "- If the context is insufficient, keep the message general rather than speculating.\n\n"
